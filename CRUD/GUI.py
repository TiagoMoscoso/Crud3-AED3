...
class GUI:
    ...
    def update_java(self, lista_elementos):
        try:
            ...
            Classe_java = jpype.JClass("Update")
            Classe_java(lista_elementos, id)
            label_updt = tkinter.Label(text="Registro alterado com sucesso!", font=("Arial", 15, "bold"), fg="#454545", bg=COR_DE_FUNDO)
            label_updt.place(x=375, y=600)
        except Exception:
    ...
    def delete_java(self, id):  
        if id == '':
            ...
            if lista_elementos[0]!="-1":
                ...
                label = tkinter.Label(text="Não foi encontrado nenhum registro com esse ID", 
                                      font=("Arial", 12, "bold"), fg="#454545", bg=COR_DE_FUNDO)
    ...
    def mostra_read(self, id, tela):
        if id == '':
            ...
            if(lista_elementos[0]!="-1"):
                ...
                label_erro = tkinter.Label(text=f"Não foi encontrado nenhum registro com o ID {id}",font=("Arial", 12, "bold"), 
                                           fg="#454545", bg=COR_DE_FUNDO)
                label_erro.place(x=250, y=450)
    ...
    def gera_base_dados(self):
        ...
        Classe_java.cria_db()
        label = tkinter.Label(text="Base de dados gerada com sucesso!",font=("Arial", 15, "bold"), fg="#454545", bg=COR_DE_FUNDO)
